...
/**
 * @author Magnus Manske, Dmitry Brant
 */

if ( typeof exports != 'undefined' ) { // Running in node.js
    var jsdom = require("jsdom");
    var $ = require("jquery")(jsdom.jsdom().defaultView);
    var autodesc_short = require('./short_autodesc.js') ;
    var reasonator_base = require('./reasonator.js') ;
    var reasonator = reasonator_base.reasonator ;
